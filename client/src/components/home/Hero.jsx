...
//       <div className="absolute inset-0 -z-10 bg-[url('/patterns/ethiopian-weave.svg')] bg-repeat opacity-10"></div>
//       <div className="absolute inset-0 -z-20 bg-gradient-to-br from-green-600/10 via-yellow-400/10 to-red-600/10"></div>

//       {/* Decorative Circles */}
//       <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-green-500/10 blur-3xl -z-10 animate-pulse-subtle"></div>
//       <div
//         className="absolute bottom-1/3 right-1/4 w-48 h-48 rounded-full bg-red-500/10 blur-2xl -z-10 animate-pulse-subtle"
...
//             Through <span className="text-primary">Online Learning</span>
//           </h1>
//           <p
//             className="text-xl md:text-2xl text-muted-foreground mb-8 animate-slide-down"
//             style={{ animationDelay: "0.1s" }}
//           >
//             Discover thousands of high-quality courses taught by industry
//             experts and enhance your skills at your own pace.
//           </p>

//           <div
//             className="relative max-w-xl mx-auto animate-slide-down"
...
//           <div
//             className="mt-10 flex flex-wrap justify-center gap-3 text-muted-foreground animate-slide-down"
